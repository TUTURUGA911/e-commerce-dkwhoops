...
def detail(id_product):
    ...
    return render_template("detail.html", user_info=user_info, is_admin=is_admin, logged_in=logged_in, info_product=info_product, testimonials=testimonials)
